document.addEventListener('DOMContentLoaded', function() {
    fetch('https://tej4dn4vh5kdlshpixsi2qdjea0nabay.lambda-url.us-east-1.on.aws') //Fetch LAMBDA FUNCTION URL - make sure to not add a trailing slash
    ...
    function generateAiDescription(imageId) {
      const aiDescriptionEndpoint = 'https://qviebqb6tudbvludftbq57tsny0spray.lambda-url.us-east-1.on.aws'; // GENERATE AI LAMBDA FUNCTION URL - and 
